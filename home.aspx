<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="Treasure.home" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    

    <header class="masthead" style="background: url(&quot;home_assets/img/header-bg.jpg&quot;), url(&quot;https://cdn.bootstrapstudio.io/placeholders/1400x800.png&quot;);">
        <div class="carousel slide" data-ride="carousel" id="carousel-1" style="padding-top: 0px;margin-top: 76px;">
            <div class="carousel-inner">
                <div class="carousel-item active"><img class="w-100 d-block pulse animated" src="home_assets/img/harrypoter.png" alt="Slide Image" style="margin-top: -3px;"></div>
                <div class="carousel-item"><img class="w-100 d-block pulse animated" src="home_assets/img/martian.jpg" alt="Slide Image"></div>
                <div class="carousel-item"><img class="w-100 d-block pulse animated" src="home_assets/img/2105008.jpg" alt="Slide Image"></div>
            </div>
    ...
    <section class="pulse animated" id="services" style="transition: ease-in;margin-top: -139px;">
        <section class="py-4 py-xl-5">
            <div class="container">
                <div class="text-center pulse animated p-4 p-lg-5">
                    ...
                    <h1 class="font-weight-bold mb-4" data-aos="slide-up">Treasure Seekers</h1><a class="btn btn-primary btn-lg mr-2 py-2 px-4" role="button" data-aos="flip-right" href="#">Explore</a><a class="btn btn-light btn-lg py-2 px-4" role="button" data-aos="flip-right" href="login.aspx">Login here</a>
                </div>
            </div>
        </section>
        <header></header>
        <div class="container">
            ...
            <div class="row text-center" data-aos="zoom-in-up" data-aos-duration="100" data-aos-delay="100">
                <div class="col-md-4" data-bss-hover-animate="pulse" style="margin-top: 10px;"><span class="fa-stack fa-4x"><img data-aos="flip-down" data-aos-duration="100" data-aos-delay="100" src="home_assets/img/man_16177356.png" width="160" height="120" style="width: 120px;height: 120px;margin-bottom: 10px;"></span>
                ...
                <div class="col-md-4" data-bss-hover-animate="pulse" style="margin-top: 10px;"><span class="fa-stack fa-4x"><img data-aos="flip-down" data-aos-duration="150" data-aos-delay="150" src="home_assets/img/needs_4968543.png" width="129" height="110" style="width: 120px;height: 120px;margin-bottom: 10px;"></span>
                ...
                <div class="col-md-4" data-bss-hover-animate="pulse" style="margin-top: 10px;"><span class="fa-stack fa-4x"><img data-aos="flip-down" data-aos-duration="200" data-aos-delay="200" src="home_assets/img/poetry_5705553.png" width="104" height="92" style="width: 120px;height: 120px;"></span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 portfolio-item" data-aos="slide-left" data-aos-duration="50" data-aos-delay="50"><a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
                        ...
                        </div><img class="img-fluid" src="home_assets/img/portfolio/book2.jpg">
                    </a>
                ...
                <div class="col-sm-6 col-md-4 portfolio-item" data-aos="flip-right" data-aos-duration="100" data-aos-delay="100"><a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="home_assets/img/portfolio/book1.jpg">
                    </a>
                ...
                <div class="col-sm-6 col-md-4 col-xl-4 portfolio-item" data-aos="flip-left" data-aos-duration="150" data-aos-delay="150"><a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="home_assets/img/portfolio/book5.jpeg">
                    </a>
                ...
                <div class="col-sm-6 col-md-4 portfolio-item" data-aos="flip-right"><a class="portfolio-link" data-toggle="modal" href="#portfolioModal4">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="home_assets/img/portfolio/book3.jpeg">
                    </a>
                    <div class="border rounded portfolio-caption">
                        <h4>Lines</h4>
                ...
                <div class="col-sm-6 col-md-4 portfolio-item" data-aos="flip-left"><a class="portfolio-link" data-toggle="modal" href="#portfolioModal5">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="home_assets/img/portfolio/book3.jpg">
                    </a>
                ...
                <div class="col-sm-6 col-md-4 portfolio-item" data-aos="flip-right"><a class="portfolio-link" data-toggle="modal" href="#portfolioModal6">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="home_assets/img/portfolio/book4.jpg">
                    </a>
                    <div class="border rounded portfolio-caption">
                        <h4>Window</h4>
                ...
                <div class="col-lg-12">
                    <ul class="list-group timeline" data-aos="fade-up" data-aos-duration="100" data-aos-delay="100">
                        <li class="list-group-item" data-bss-hover-animate="pulse">
                            <div data-aos="fade" data-aos-duration="100" data-aos-delay="100" class="timeline-image"><img class="rounded-circle img-fluid" data-aos="fade" data-aos-duration="100" data-aos-delay="100" src="home_assets/img/about/hand_12640222.png" style="margin-top: 8px;margin-right: 0px;padding-right: 0px;"></div>
                        ...
                        <li class="list-group-item timeline-inverted" data-bss-hover-animate="pulse">
                            <div data-aos="zoom-in-up" data-aos-duration="100" data-aos-delay="100" class="timeline-image"><img class="rounded-circle img-fluid" data-bss-hover-animate="pulse" src="home_assets/img/about/analyzing_9871680.png" style="margin-left: 2px;padding-top: 0px;margin-top: 4px;padding-right: 0px;margin-right: -5px;"></div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                        ...
                        <li class="list-group-item" data-bss-hover-animate="pulse">
                            <div data-aos="slide-up" data-aos-duration="100" data-aos-delay="100" class="timeline-image"><img class="rounded-circle img-fluid" data-aos="slide-up" data-aos-duration="100" data-aos-delay="100" src="home_assets/img/about/book_1754346.png" style="margin-right: -13px;padding-top: 0px;margin-top: -2px;padding-bottom: 3px;margin-bottom: -3px;"></div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                        ...
                        <li class="list-group-item timeline-inverted" data-bss-hover-animate="pulse">
                            <div data-aos="slide-up" data-aos-duration="100" data-aos-delay="100" class="timeline-image"><img class="rounded-circle img-fluid" data-aos="slide-up" data-aos-duration="100" data-aos-delay="100" src="home_assets/img/about/reading_4589309.png" style="padding-top: 0px;margin-top: -1px;"></div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4" data-bss-hover-animate="pulse">
                    <div class="team-member"><img class="rounded-circle mx-auto" data-aos="slide-up" data-aos-duration="100" data-aos-delay="100" src="home_assets/img/team/3.jpg">
                ...
                <div class="col-sm-4" data-bss-hover-animate="pulse">
                    <div class="team-member"><img class="rounded-circle mx-auto" data-aos="slide-up" data-aos-duration="100" data-aos-delay="100" src="home_assets/img/team/Untitled%20design%20(2).png">
                ...
                <div class="col-sm-4" data-bss-hover-animate="pulse">
                    <div class="team-member"><img class="rounded-circle mx-auto" data-aos="slide-up" data-aos-duration="100" data-aos-delay="100" src="home_assets/img/team/2.jpg">
    ...
    <section class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-3" data-aos="flip-up"><a href="#"><img class="img-fluid d-block mx-auto" src="home_assets/img/clients/Untitled%20design%20(3).png"></a></div>
                <div class="col-sm-6 col-md-3" data-aos="flip-down"><a href="#"><img class="img-fluid d-block mx-auto" src="home_assets/img/clients/penguin%20(1).png"></a></div>
                <div class="col-sm-6 col-md-3" data-aos="flip-up"><a href="#"><img class="img-fluid d-block mx-auto" src="home_assets/img/clients/penguin%20(2).png"></a></div>
                <div class="col-sm-6 col-md-3" data-aos="flip-down"><a href="#"><img class="img-fluid d-block mx-auto" src="home_assets/img/clients/penguin%20(3).png"></a></div>
            </div>
        </div>
    </section>
    <section data-aos="slide-up" data-aos-duration="50" data-aos-delay="50" id="contact" style="background-image:url('home_home_assets/img/map-image.png');">
        <div class="container">
            <div class="row">
