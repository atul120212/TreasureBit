<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="welcome_admin.aspx.cs" Inherits="Treasure.welcome_admin" %>
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow mx-1">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="badge bg-danger badge-counter">7</span><i class="fas fa-envelope fa-fw"></i></a>
                                    <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                        <h6 class="dropdown-header">alerts center</h6><a class="dropdown-item d-flex align-items-center" href="#">
                                            <div class="dropdown-list-image me-3"><img class="rounded-circle" src="admin_assets/img/avatars/avatar4.jpeg">
                                            ...
                                            <div class="dropdown-list-image me-3"><img class="rounded-circle" src="admin_assets/img/avatars/avatar2.jpeg">
                                            ...
                                            <div class="dropdown-list-image me-3"><img class="rounded-circle" src="admin_assets/img/avatars/avatar3.jpeg">
                                            ...
                                            <div class="dropdown-list-image me-3"><img class="rounded-circle" src="admin_assets/img/avatars/avatar5.jpeg">
                                                <div class="bg-success status-indicator"></div>
                                            </div>
                                            <div class="fw-bold">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">
                                    <span class="d-none d-lg-inline me-2 text-gray-600 small"><% Response.Write(Session["fullname"]); %> </span>
                                    <img class="border rounded-circle img-profile" src="<% Response.Write(Session["myimg"]); %>"></a>
                            ...
                            <div class="card shadow border-left-primary py-2">
                                <div class="card-body">
                                    <div class="row g-0 align-items-center">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Users Online</span></div>
                                            <div class="text-dark fw-bold h5 mb-0">
                                                <span>
        <asp:Label ID="online_user" runat="server" Text="Label"></asp:Label>
                                                    </span>
